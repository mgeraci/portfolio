...
(function(){var keys,newWindow,photoLoader,programNotes,stylesheets,thumbnails,web,webKeys,webNext,webPreload,webPrev;stylesheets=function(){if(jQuery.browser.safari){$('head').append("<link type='text/css' rel='stylesheet' href='/style/safari.css'>");}
