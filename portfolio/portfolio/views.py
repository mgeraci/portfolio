...
def steel(request):
    steels = [
        {
            'youtube': 'https://www.youtube.com/watch?v=VrAUdLb7jLA',
        ...
        {
            'youtube': 'https://www.youtube.com/watch?v=EMJgfaK0KBU',
        ...
        {
            'youtube': 'https://www.youtube.com/watch?v=ZrlvAjUCP8U',
        ...
        {
            'youtube': 'https://www.youtube.com/watch?v=kxqzHEAiwHY',
        ...
        {
            'youtube': 'https://www.youtube.com/watch?v=x691_sB19Ww',
        ...
        {
            'youtube': 'https://www.youtube.com/watch?v=UaLBILfJ5ag',
        ...
        {
            'youtube': 'https://www.youtube.com/watch?v=Jjym9fKzE5U',
