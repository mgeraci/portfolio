      ...
      <div id="pageComposition">
        ...
        <?php } elseif ($piece == 'heptadecality') { ?>
          <div id="pieceContent">
            ...
            <br>&nbsp;
            <br>&nbsp;
            <iframe src="http://player.vimeo.com/video/3194292?title=0&amp;byline=0&amp;portrait=0&amp;color=bbd199" width="430" height="287" frameborder="0"></iframe>
            <br>&nbsp;
            <br>&nbsp;
          </div>
        <?php } elseif ($piece == 'futility') { ?>
          <div id="pieceContent">
            ...
            <br>
            <br>
            <iframe src="http://player.vimeo.com/video/3194557?title=0&amp;byline=0&amp;portrait=0&amp;color=bbd199" width="430" height="323" frameborder="0"></iframe>
          </div>
        <?php } elseif ($piece == 'firstFlesh') { ?>
          <div id='pieceContent'>
            ...
            <div class="left">
              <iframe src="http://player.vimeo.com/video/3194071?title=0&amp;byline=0&amp;portrait=0&amp;color=bbd199" width="430" height="325" frameborder="0"></iframe>
        ...
        <?php } elseif ($piece == 'though') { ?>
          <div id='pieceContent'>
            <div class="centered">
              <h1>Though We Don't Know What To Do,<br>We Know How To Do It, 2006</h1>
              <br>For Tape and Structured Improvisational Dance, 8:57"
            </div>
            <div class="left">
              With Emily Bielagus, Alexandra Daves, Ben Greene, Hayley Leddington, and Emily Palmer
              <br>
              <br>Text composed and read by David Reese
              <br>
              <br><iframe src="http://player.vimeo.com/video/19170814?title=0&amp;byline=0&amp;portrait=0&amp;color=bbd199" width="430" height="284" frameborder="0"></iframe>
              <br>
        ...
        <?php } elseif ($piece == 'home') { ?>
          <div id="pieceContent">
            ...
            <br>&nbsp;
            <br>&nbsp;
            <iframe src="http://player.vimeo.com/video/3194629?title=0&amp;byline=0&amp;portrait=0&amp;color=bbd199" width="430" height="330" frameborder="0"></iframe>
            <br>&nbsp;
            <br>&nbsp;
          </div>
        ...
        <?php } elseif ($piece == 'blood') { ?>
          <div id="pieceContent">
            ...
            <br>&nbsp;
            <br>&nbsp;
            <iframe src="http://player.vimeo.com/video/6657539?title=0&amp;byline=0&amp;portrait=0&amp;color=bbd199" width="430" height="323" frameborder="0"></iframe>
            <br>&nbsp;
            <br>&nbsp;
        <?php }  ?>
      </div>
